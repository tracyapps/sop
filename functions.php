...
// commenting out the if statement since this is a multisite install
//if ( is_plugin_active( get_template_directory() . '/assets/plugins/advanced-custom-fields-pro/acf.php' ) ) {
	// Import ACF fields
